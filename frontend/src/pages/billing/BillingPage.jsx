...
import {
  ...
  createMercadoPagoPreference, exportEstimates, exportInvoices, listEstimates, listInvoices,
...
import { downloadBillingPdf } from "../../pdf/billingPdf.jsx";
...
export default function BillingPage() {
  ...
  const downloadPdf = async (documentType, record, filename) => {
    try {
      await downloadBillingPdf({ documentType, record, filename });
    } catch (error) {
